...
document.getElementById("btn_next").onclick = function () {
    let tmp = parseInt(document.getElementById("edit_t_item_position").value);
...
function displayPoker(i) {
    ...
    document.getElementById("edit_t_item_position").value = i;
...
function saveTask() {
    ...
    let item_position = document.getElementById("edit_t_item_position").value;
